<div class="morph-dialog-field">
    ...
    <div class="control">
        <input id="image_normal_width" type="text" name="morph_template_settings_masonry[image_normal_width]" value="<?php echo esc_attr($template_settings['image_normal_width']); ?>">
    </div>
</div>
<div class="morph-dialog-field">
    <div class="label">
    ...
    <div class="control">
        <input id="image_normal_height" type="number" name="morph_template_settings_masonry[image_normal_height]" value="<?php echo esc_attr($template_settings['image_normal_height']); ?>">
    </div>
</div>
<div class="morph-dialog-field">
    <div class="label">
    ...
    <div class="control">
        <select id="image_normal_resize_mode" name="morph_template_settings_masonry[image_normal_resize_mode]">
...
<div class="morph-dialog-field">
    ...
    <div class="control">
        <input id="image_full_width" type="text" name="morph_template_settings_masonry[image_full_width]" value="<?php echo esc_attr($template_settings['image_full_width']); ?>">
    </div>
</div>
<div class="morph-dialog-field">
    <div class="label">
    ...
    <div class="control">
        <input id="image_full_height" type="number" name="morph_template_settings_masonry[image_full_height]" value="<?php echo esc_attr($template_settings['image_full_height']); ?>">
    </div>
</div>
<div class="morph-dialog-field">
    <div class="label">
    ...
    <div class="control">
        <select id="image_full_resize_mode" name="morph_template_settings_masonry[image_full_resize_mode]">
