...
class Masonry implements TemplateInterface {
    ...
    public function get_editor_fields_html(){
        $this->view->set_view_folder( $this->dir_path );
        return $this->view->get_render( 'views/editor-fields.php' );
    }

	public function wp_head_hook($gallery_id, $items, $settings, $template_settings){
	...
	public function save_hook($gallery_id, $items, $settings, $template_settings ){
        ...
        foreach( $items as $item ){
            ...
            if ( @file_exists( $image_path ) ) {
                ...
                // Full images
                $width = $template_settings['image_full_width'];
                $height = $template_settings['image_full_height'];
                $resize_mode = $template_settings['image_full_resize_mode'];
                $this->_create_variant(
                    'full',
                    $gallery_id,
                    $item,
