...
class Paginator {
    ...
    */
    public function __construct($total=0, $current_page=1, $per_page=10, $pages_width=null){
        
        $this->paginate($total, $current_page, $per_page, $pages_width);
    }
    ...
    * @param int $pages_width Number of pages to show on left and right of current page.
    */
    public function paginate($total, $current_page=1, $per_page=10, $pages_width=null){
        ...
        $this->next_page = $this->compute_next_page($current_page);
    ...
    */
    public function compute_next_page($current_page){
    ...
    *
    * @param array $data One dimensional array of records
